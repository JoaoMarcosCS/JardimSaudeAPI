...
const tratamentosNefrologicosEmAndamento = <Tratamento[]>[];
...
for (let i = 0; i < 24; i++) {
    ...
    tratamentosNefrologicosEmAndamento.push(tratamento);
}

export default tratamentosNefrologicosEmAndamento;