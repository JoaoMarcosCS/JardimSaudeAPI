...
const tratamentosOftalmologicosEmAndamento = <Tratamento[]>[];
...
for (let i = 0; i < 24; i++) {
    ...
    tratamentosOftalmologicosEmAndamento.push(tratamento);
}

export default tratamentosOftalmologicosEmAndamento;