...
const tratamentosOncologicos = <Tratamento[]>[];
...
for (let i = 0; i < 24; i++) {
    ...
    tratamentosOncologicos.push(tratamentoCancelado, tratamentoEmAndamento, tratamentoFinalizado);
}

export default tratamentosOncologicos;