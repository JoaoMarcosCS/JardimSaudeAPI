...
const tratamentosOrtopedicos = <Tratamento[]>[];
...
for (let i = 0; i < 24; i++) {
    ...
    tratamentosOrtopedicos.push(tratamentoCancelado, tratamentoEmAndamento, tratamentoFinalizado);
}

export default tratamentosOrtopedicos;