...
const tratamentosOftalmologicosCancelados = <Tratamento[]>[];
...
for (let i = 0; i < 24; i++) {
    ...
    tratamentosOftalmologicosCancelados.push(tratamento);
}

export default tratamentosOftalmologicosCancelados;