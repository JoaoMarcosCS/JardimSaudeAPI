...
const tratamentosOftalmologicos = <Tratamento[]>[];
...
for (let i = 0; i < 36; i++) {
    ...
    tratamentosOftalmologicos.push(tratamentoCancelado, tratamentoEmAndamento, tratamentoFinalizado);
}

export default tratamentosOftalmologicos;