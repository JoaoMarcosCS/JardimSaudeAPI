...
const tratamentosNefrologicos = <Tratamento[]>[];
...
for (let i = 0; i < 54; i++) {
    ...
    tratamentosNefrologicos.push(tratamentoCancelado, tratamentoEmAndamento, tratamentoFinalizado);
}

export default tratamentosNefrologicos;