...
const tratamentosFisioterapeuticosFinalizados = <Tratamento[]>[];
...
for (let i = 0; i < 24; i++) {
    ...
    tratamentosFisioterapeuticosFinalizados.push(tratamento);
}

export default tratamentosFisioterapeuticosFinalizados;