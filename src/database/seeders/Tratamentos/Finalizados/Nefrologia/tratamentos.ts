...
const tratamentosNefrologicosFinalizados = <Tratamento[]>[];
...
for (let i = 0; i < 24; i++) {
    ...
    tratamentosNefrologicosFinalizados.push(tratamento);
}

export default tratamentosNefrologicosFinalizados;