...
const tratamentosGastroenterologistaFinalizados = <Tratamento[]>[];
...
for (let i = 0; i < 24; i++) {
    ...
    tratamentosGastroenterologistaFinalizados.push(tratamento);
}

export default tratamentosGastroenterologistaFinalizados;