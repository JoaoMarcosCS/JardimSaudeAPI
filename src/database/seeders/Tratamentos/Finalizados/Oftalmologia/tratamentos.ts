...
const tratamentosOftamologicosFinalizados = <Tratamento[]>[];
...
for (let i = 0; i < 24; i++) {
    ...
    tratamentosOftamologicosFinalizados.push(tratamento);
}

export default tratamentosOftamologicosFinalizados;